...
#
# Generated by export_simulation on Tue Jan 16 18:17:10 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_pixel.sh' script.

./blk_mem_gen_pixel.sh -reset_run
...
./blk_mem_gen_pixel.sh -noclean_files

For more information on the script, please type './blk_mem_gen_pixel.sh -help'.
