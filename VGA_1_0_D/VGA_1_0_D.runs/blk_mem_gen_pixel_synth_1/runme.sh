...
HD_PWD='C:/Zynq_Book/VGA_1_0_D/VGA_1_0_D.runs/blk_mem_gen_pixel_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_pixel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_pixel.tcl
