...
HD_PWD='C:/Zynq_Book/VGA_mem_mapped/VGA_mem_mapped.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_top_wrapper.tcl -notrace
