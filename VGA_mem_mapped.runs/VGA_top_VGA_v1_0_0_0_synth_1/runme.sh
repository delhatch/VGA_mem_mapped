...
HD_PWD='C:/Zynq_Book/VGA_mem_mapped/VGA_mem_mapped.runs/VGA_top_VGA_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_top_VGA_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_top_VGA_v1_0_0_0.tcl
